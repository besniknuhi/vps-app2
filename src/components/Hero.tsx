      ...
      <div className="grid items-center justify-between gap-10 lg:grid-cols-12">
        <div className="lg:col-span-7">
          ...
          <div className="flex items-center gap-4 mt-16">
            <Link
              href="#plans"
              className="border-transparent rounded-full bg-[#9DB2BF] text-[rgb(0,23,26)] text-lg leading-7 py-3 px-8 font-bold hover:bg-[#465158] duration-300"
            >
              Get started
            </Link>
            <Link
              href="/"
              className="border border-[#515c63] rounded-full bg-[rgb(0,23,26)] text-[#9DB2BF] hover:text-[#ccd8df] text-lg leading-7 py-3 px-8 font-bold hover:bg-[#444e53] duration-300"
            >
              Contact us
            </Link>
          </div>
